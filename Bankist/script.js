...
const slider = function () {
  ...
  // The arrow sliding event starts here
...
// headerr.append(message);
// headerr.append(message.cloneNode(true));

// headerr.before(message);
// headerr.after(message);
...
h11.addEventListener("mouseenter", alertH1);

setTimeout(() => h11.removeEventListener("mouseenter", alertH1), 3000);
